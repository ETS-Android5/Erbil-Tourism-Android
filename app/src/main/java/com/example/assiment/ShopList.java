...
public class ShopList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getResources().getString(R.string.listShop));
        ...
        list = new ArrayList<>();
        adapter = new ShopListAdapter(this, R.layout.place_items, list);
        gridView.setAdapter(adapter);

        // get all data from sqlite
        Cursor cursor = MainActivity.sqLiteHelper.getData("SELECT * FROM Shop");
        list.clear();
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
                if (!s.equals("admin")){
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(ShopList.this);
                    ...
                    dialog.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (item == 0) {
                                Cursor c = MainActivity.sqLiteHelper.getData("SELECT idFB FROM Shop");
                            ...
                            if (item == 1) {
                                Cursor c = MainActivity.sqLiteHelper.getData("SELECT cor1 FROM Shop");
                                Cursor c2 = MainActivity.sqLiteHelper.getData("SELECT cor2 FROM Shop");
                                ...
                                Intent intent = new Intent(ShopList.this , MapsActivity2.class);
                    ...
                    dialog.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (item == 2) {
                                // update
                                Cursor c = MainActivity.sqLiteHelper.getData("SELECT id FROM Shop");
                                ArrayList<Integer> arrID = new ArrayList<Integer>();
                                while (c.moveToNext()) {
                                    arrID.add(c.getInt(0));
                                }
                                // show dialog update at here
                                showDialogUpdate(ShopList.this, arrID.get(position));
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    MainActivity.sqLiteHelper.updateShop(
    ...
    private void showDialogDelete(final int idFood){
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(ShopList.this);
        ...
        dialogDelete.setPositiveButton(getResources().getString(R.string.OK), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    MainActivity.sqLiteHelper.deleteShop(idFood);
                    Toast.makeText(getApplicationContext(), ""+getResources().getString(R.string.updateSec),Toast.LENGTH_SHORT).show();
                } catch (Exception e){
