...
public class HotelList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getResources().getString(R.string.listhotel));
        ...
        list = new ArrayList<>();
        adapter = new HotelListAdapter(HotelList.this, R.layout.place_items, list);
        ...
        Cursor cursor = MainActivity.sqLiteHelper.getData("SELECT * FROM Hotel");
            ...
            while (cursor.moveToNext()) {
                ...
                list.add(new Place(name, address, image, id, idFB));
            }
                 ...
                 if (!s.equals("admin")){
                   ...
                   dialog.setItems(items, new DialogInterface.OnClickListener() {
                       ...
                       public void onClick(DialogInterface dialog, int item) {
                           if (item == 0) {
                               Cursor c = MainActivity.sqLiteHelper.getData("SELECT idFB FROM Hotel");
                           ...
                           if (item == 1) {
                               Cursor c = MainActivity.sqLiteHelper.getData("SELECT cor1 FROM Hotel");
                               Cursor c2 = MainActivity.sqLiteHelper.getData("SELECT cor2 FROM Hotel");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewPlace = (ImageView) dialog.findViewById(R.id.imageViewFood);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    MainActivity.sqLiteHelper.updateHotel(
                            edtName.getText().toString().trim(),
                            edtPrice.getText().toString().trim(),
                            AddPlace.imageViewToByte(imageViewPlace),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idFood){
        ...
        dialogDelete.setPositiveButton(getResources().getString(R.string.OK), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    MainActivity.sqLiteHelper.deleteHotel(idFood);
                    Toast.makeText(getApplicationContext(), ""+getResources().getString(R.string.updateSec),Toast.LENGTH_SHORT).show();
                } catch (Exception e){
